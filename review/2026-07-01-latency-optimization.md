...
### 다음 후보
- (a) **v6 스윗스팟** 탐색: ~600자·제품 3개·grounding 규칙 verbatim 유지 → 품질을 v4 CI 안에 두면서 ~20~25% 단축 노림.
- (b) **v4 유지 + 스트리밍이 latency 답**으로 결론(공격적 축소는 품질 대비 이득 부족).

**상태:** P3 측정·게이트 완료(v5 반려). (a)/(b) 결정 대기.
